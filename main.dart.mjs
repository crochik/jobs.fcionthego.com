...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1351: (x0,x1) => x0.key(x1),
      _1360: () => globalThis.removeSplashFromWeb(),
      _1361: Date.now,
      ...
      _1631: (a, i) => a.splice(i, 1)[0],
      _1634: a => a.pop(),
      _1635: (a, i) => a.splice(i, 1),
      _1636: (a, s) => a.join(s),
      _1637: (a, s, e) => a.slice(s, e),
      _1639: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1640: a => a.length,
      ...
      _1646: (o, offsetInBytes, lengthInBytes) => {
      ...
      _1649: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1650: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int8Array) return 1;
        return 2;
      },
      _1651: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1652: o => o instanceof Uint8ClampedArray,
      _1653: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1654: o => o instanceof Uint16Array,
      _1655: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1656: o => o instanceof Int16Array,
      ...
      _1659: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1660: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int32Array) return 1;
        return 2;
      },
      _1661: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1663: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1664: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float32Array) return 1;
        return 2;
      },
      _1665: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1666: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float64Array) return 1;
        return 2;
      },
      _1667: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1668: (a, i) => a.push(i),
      _1669: (t, s) => t.set(s),
      ...
      _1699: Function.prototype.call.bind(BigInt.prototype.toString),
      _1700: Function.prototype.call.bind(Number.prototype.toString),
      _1701: (d, digits) => d.toFixed(digits),
      ...
      _1800: x0 => x0.readyState,
      _1802: (x0,x1) => { x0.timeout = x1 },
      _1804: (x0,x1) => { x0.withCredentials = x1 },
      _1805: x0 => x0.upload,
      _1806: x0 => x0.responseURL,
      _1807: x0 => x0.status,
      _1808: x0 => x0.statusText,
      _1810: (x0,x1) => { x0.responseType = x1 },
